...
if (isset($_POST['search'])) {
    ...
    $query = "SELECT * FROM `registered_accounts` WHERE CONCAT(`Username`, `Email`, `Password`) LIKE '%" . $valueToSearch . "%'";
                    ...
                    <ul id="iq-sidebar-toggle" class="iq-menu">
                        ...
                        <li class="">
                            <a href="indexRegistered.php" class="">
                                <svg class="svg-icon" id="p-dash6" width="20" height="20" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="#226A80" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <div class="col-lg-4">
                        <div class="card card-transparent card-block card-stretch card-height border-none">
                            <div class="card-body p-0 mt-lg-2 mt-0">
                                <h3 style="color: #226A80;" class="mb-3">Users</h3>
