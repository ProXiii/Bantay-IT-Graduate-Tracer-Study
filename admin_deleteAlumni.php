...
if (isset($_GET['delete'])) {
    ...
    $delete_query = mysqli_query($con, "DELETE FROM form_answers WHERE alumni_StudentNumber = $delete_id ") or die('query failed');
    if ($delete_query) {
        header('location:admin_deleteAlumni.php');
...
if (isset($_POST['search'])) {
    ...
    $query = "SELECT * FROM `form_answers` WHERE CONCAT(`alumni_StudentNumber`,`alumni_LastName`,`alumni_FirstName`,`alumni_MiddleName`, `alumni_YearGraduated`) LIKE '%" . $valueToSearch . "%'";
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="card card-transparent card-block card-stretch card-height border-none">
                            <div class="card-body p-0 mt-lg-2 mt-0">
                                <h3 style="color: #8e3041;" class="mb-3">Delete Alumni</h3>
                                <p style="width: 600px;" class="mb-0 mr-4">
                                    The users list provides
                                    space to list your registered users in the most appealing way.</p>
                    ...
                    <div class="container">
                        <form action="" method="post">
                            ...
                            <div style="position:relative;left:675px;bottom: 87px" class="row">
                                <div class="button">
                                ...
                                <tbody>
                                    ...
                                    <?php while ($row = mysqli_fetch_array($search_result)) : ?>
                                        <tr>
                                            ...
                                            <td><?php echo $row['alumni_StudentNumber']; ?></td>
                                            <td><?php echo $row['alumni_LastName']; ?>, <?php echo $row['alumni_FirstName']; ?> <?php echo $row['alumni_MiddleName']; ?></td>
                                            <td><?php echo $row['alumni_YearGraduated']; ?></td>
                                            <td>

                                                <a href="admin_deleteAlumni.php?delete=<?php echo $row['alumni_StudentNumber']; ?>" class="delete-btn" onclick="return confirm('are your sure you want to delete this?');"> <i class="fas fa-trash"> delete </i></a>
                                            </td>
