...
if (isset($_POST['search'])) {
    ...
    $query = "SELECT * FROM form_answers WHERE CONCAT(alumni_LastName, alumni_FirstName , alumni_StudentNumber, alumni_YearGraduated, alumni_EmployementStatus) LIKE '%" . $valueToSearch . "%'";
