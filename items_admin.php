...
if (isset($_POST['add_product'])) {
    ...
    $p_image_folder = './images/products/' . $p_image;

    $insert_query = ("INSERT INTO products(name, price, image, description, category) VALUES('$p_name', '$p_price', '$p_image', '$p_desc', '$p_categ')") or die('query failed');
...
if (isset($_POST['update_product'])) {
    ...
    $update_p_categ = $_POST['update_p_categ'];
    $update_p_price = $_POST['update_p_price'];
    $update_p_image = $_FILES['update_p_image']['name'];
    $update_p_image_tmp_name = $_FILES['update_p_image']['tmp_name'];
    $update_p_image_folder = './images/products/' . $update_p_image;

    $update_query = mysqli_query($con, "UPDATE `products` SET name = '$update_p_name', description = '$update_p_desc', category = '$update_p_categ', price = '$update_p_price', image = '$update_p_image' WHERE id = '$update_p_id'");
...
<body class="  ">
    ...
    if (isset($message)) {
        foreach ($message as $message) {
            echo '<div style="background-color:#226A80" class="message"><span style="color:#fff">' . $message . '</span> <i class="fas fa-times" onclick="this.parentElement.style.display = `none`;"></i> </div>';
        };
    };
    ...
    <div class="wrapper">
        ...
        <div class="content-page">
                    ...
                    <div class="col-lg-4">
                        <div class="card card-transparent card-block card-stretch card-height border-none">
                            <div class="card-body p-0 mt-lg-2 mt-0">
                                <h3 style="color: #226A80;" class="mb-3">Add Item</h3>

                                <p style="width: 600px;" class="mb-0 mr-4">The items list effectively dictates product presentation and provides
                            ...
                            <form action="#" method="post" enctype="multipart/form-data">
                                <div class="details">
                                    ...
                                    <div class="txt_field">
                                        ...
                                        <input type="text" name="p_categ" required>
                                    </div>
                                    <div class="txt_field">
                                    ...
                                    <div class="txt_field">
                                        ...
                                        <input type="number" name="p_price" min="0" required>
                                    </div>
                                    
                                        <label>Insert Image</label>
                                        <input style="padding: 1.5px 0 0 125px;position:relative;right:720px;top:36px" type="file" name="p_image" accept="image/png, image/jpg, image/jpeg" required>
                        ...
                        <table style="margin-top: 25px;width: 1000px;" class="rwd-table">
                            <tbody>
                                <tr>
                                    <th>Product Image</th>
                                    <th>Product Name</th>
                                 ...
                                 <?php
                                    ...
                                    ?>
                                            ...
                                            <tr>
                                                <td><img src="./images/products/<?php echo $row['image']; ?>" height="100" alt=""></td>
                                                <td><?php echo $row['name']; ?></td>
                                                <td><?php echo $row['category']; ?></td>
                                                <td><?php echo $row['description']; ?></td>
                                                <td>$<?php echo $row['price']; ?>/-</td>
                                                <td>
                                                    <a href="items_admin.php?delete=<?php echo $row['id']; ?>" class="delete-btn" onclick="return confirm('are your sure you want to delete this?');"> <i class="fas fa-trash"> delete </i></a>
                                                    <a href="items_admin.php?edit=<?php echo $row['id']; ?>" class="option-btn"> <i class="fas fa-edit">update</i>  </a>
                                                </td>
                                            </tr>
                        ...
                        <section class="edit-form-container">
                            ...
                            ?>
                                        ...
                                        <form action="" method="post" enctype="multipart/form-data">
                                            ...
                                            <input type="text" class="box" required name="update_p_categ" value="<?php echo $fetch_edit['category']; ?>">
            ...
            <script>document.querySelector('#close-edit').onclick = () =>{
   document.querySelector('.edit-form-container').style.display = 'none';
   window.location.href = 'items_admin.php';
};</script>
